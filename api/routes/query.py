    ...
    return QueryResponse(
        ...
        results=[
            ResultRecord(
                ...
                facet_match=getattr(r, "facet_match", {}) or {},
            )
        ...
        provenance=ProvenanceOut(
            ...
            parsed_filters=getattr(resp.provenance, "parsed_filters", {}) or {},
            ...
            # Phase 38: the coordinator builds the full step-by-step trace
            # (coordinator.py:762) but it was never forwarded here, so the
            # frontend's reasoning panel always received null. Forward it.
            reasoning_trace=getattr(resp.provenance, "reasoning_trace", None),
        ),
