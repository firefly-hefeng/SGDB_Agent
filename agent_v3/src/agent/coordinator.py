...
class CoordinatorAgent:
    ...
    def create(
        ...
        if llm:
            try:
                from ..understanding.v1_parser import V1QueryParser
                parser = V1QueryParser(llm=llm, schema_knowledge=sk)
        ...
        # V3: No separate enricher - V1Parser handles all enrichment
